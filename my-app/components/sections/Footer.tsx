// my-app/components/sections/Footer.tsx
  ...
  return (
    <footer className="relative w-full h-150 overflow-hidden bg-transparent">
      ...
      <div className="relative w-full h-full flex flex-col justify-between z-10 pb-32">
        ...
        {/* pointer-events-none ensures the massive circle doesn't block clicking social icons */}
        ...
        {/* Bottom Area Wrapper (Corners + Copyright + Giant Text) */}
